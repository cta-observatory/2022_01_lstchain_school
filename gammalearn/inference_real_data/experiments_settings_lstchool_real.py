...
loss_options = {
    ...
    "logvar_coeff": [2, 2, 2, 0.5],  # for uncertainty (coeff on log variance)
...
"""dict: optional, the parameters of the dataset specific to the test operation.
    Updates parameters in the `dataset_parameters` dict
"""
test_image_filter = {
# #     utils.intensity_filter: {"intensity": [50, np.inf]},
# #     utils.cleaning_filter: {"picture_thresh": 8, "boundary_thresh": 4,
    # #                         "keep_isolated_pixels": False, "min_number_picture_neighbors": 2},
#     utils.leakage_filter: {"leakage2_cut": 0.2, "picture_thresh": 8, "boundary_thresh": 4,
#                            "keep_isolated_pixels": False, "min_number_picture_neighbors": 2},
}
"""dict: optional"""
